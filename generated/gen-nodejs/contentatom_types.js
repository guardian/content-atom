...
Atom = module.exports.Atom = function(args) {
  ...
  if (args) {
    ...
    if (args.defaultHtml !== undefined && args.defaultHtml !== null) {
    ...
    if (args.data !== undefined && args.data !== null) {
      this.data = new ttypes.AtomData(args.data);
    } else {
...
ContentAtomEvent = module.exports.ContentAtomEvent = function(args) {
  ...
  if (args) {
    if (args.atom !== undefined && args.atom !== null) {
      this.atom = new ttypes.Atom(args.atom);
    } else {
